-- ============================================
-- ADMIN CORE SYSTEM - ENTERPRISE EDITION
-- Professional administrative interface and commands
-- ============================================
...
-- ============================================
-- EXPORTS (FOR ENTERPRISE INTEGRATION)
-- ============================================

exports('hasAdminPermission', hasAdminPermission)
exports('hasSimpleAdminPermission', hasSimpleAdminPermission)
...
AddEventHandler('onResourceStart', function(resourceName)
    if resourceName == GetCurrentResourceName() then
        print('^2[ADMIN CORE] 🏗️ Enterprise admin system loaded!^0')
        print('^2[ADMIN CORE] Use /supply for admin menu or "supply help" in console^0')
        print('^2[ADMIN CORE] Available commands: /supplyjobreset, /supplyjobmassreset, /supplyemergencyrestart^0')
    end
end)

print("^2[ADMIN CORE] 🏆 Enterprise admin core system initialized^0")